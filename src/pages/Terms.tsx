...
const sections = [
  ...
  { title: "Intellectual Property", body: "All content, designs, photographs, and drawings on this site are the property of AURA Studio and protected by copyright and trademark law." },
  ...
  { title: "Project Engagements", body: "Any professional engagement with AURA Studio is governed by a separate written agreement, not by these website terms." },
